...
@injectable()
export class SendNotificationEmployeeOnLeaveRequestRejected implements DomainEventSubscriber<LeaveRequestApprovedDomainEvent> {
  ...
  name(): string {
    return "company.send_email_employee_on_leave_request_rejected";
  }
}
